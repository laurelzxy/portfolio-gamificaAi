...
export class Player extends Actor {
    ...
    onInitialize(engine: Engine<any>): void {
        ...
        engine.input.keyboard.on("press", (event) => {
            // Se a tecla pressionada for a F e tievr objeto proximo 
            if (event.key == Keys.F && this.temObjetoProximo) {
                // console.log("Interagiuuu");

                // Indentificar o alvo da interacao 
                if (this.ultimoColisor?.owner.name == "mesa_strand_a") {
